 ...
 * @param requestUri              location returned by the PAR endpoint to be used by the client
 *                                this value is part of the PAR (RFC9126) specification
 * @param principal               principal that is allowed to register with this verification session
 * @param subject                 subject claim in the token returned by the verification provider
 * @param verified                whether the session has been verified for the principal
 * @param createdTimestamp        when this session was created
 * @param updatedTimestamp        when this session was updated
 * @param remoteExpirationSeconds when the remote session expires, referring to the PAR session
 *                                this value is part of the PAR (RFC9126) specification
 * @see CreateVerificationSessionResponse
 */
