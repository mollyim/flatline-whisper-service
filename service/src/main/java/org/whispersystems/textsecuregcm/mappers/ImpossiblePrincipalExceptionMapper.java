...
public class ImpossiblePrincipalExceptionMapper implements ExceptionMapper<InvalidPrincipalException> {
  ...
  @Override
  public Response toResponse(final InvalidPrincipalException exception) {
