...
public class ImpossiblePrincipalExceptionMapper implements ExceptionMapper<ImpossiblePrincipalNumberException> {
  ...
  @Override
  public Response toResponse(final ImpossiblePrincipalNumberException exception) {
