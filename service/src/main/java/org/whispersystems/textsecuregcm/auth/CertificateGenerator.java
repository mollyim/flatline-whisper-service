...
public class CertificateGenerator {
  ...
  public byte[] createFor(final Account account, final byte deviceId, boolean includePrincipal) throws InvalidKeyException {
    ...
    if (includePrincipal) {
      builder.setSender(account.getPrincipal());
    }
